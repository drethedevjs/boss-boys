export const files = [
  {
    ...
    description:
      "A students journey starts here. This form is for the students to get 100 signatures from anyone.",
    fileName: "nomination-signature-sheet.pdf"
  },
  {
    title: "BOSS Pledge",
    description: "This is the pledge that every boss member must memorize.",
    fileName: "pledge.pdf"
  },
  {
